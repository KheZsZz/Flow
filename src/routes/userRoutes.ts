...
router.post("/", authMiddleware.authUser, authMiddleware.reqCompany, userController.signUp);
router.put("/:id", authMiddleware.authUser, authMiddleware.requireRole('Admin'), authMiddleware.reqCompany, userController.update);
router.patch("/:id", authMiddleware.authUser,authMiddleware.requireRole('Admin'), userController.disable);
router.delete("/:id", authMiddleware.authUser,authMiddleware.requireRole('Admin'), userController.delete);
